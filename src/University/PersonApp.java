...
public class PersonApp {
	...
	public static void main(String[] args) throws IOException {
		...
		while (looping) {
			...
			Person person = new Person(firstName, middleName, lastName, email, ssn, age, personCount, true);
		...
		Person i1 = new Instructor("Robert", "WineBeard", "Baratheon", "TheKing@KingsLanding.com", "001-01-0001", 49,
				123, "Athletics");
		Person s1 = new Student("Meriel", "Katarina", "Stein", "steinm6@students.rowan.edu", "123-45-6789", 20, 234,
				"Computer Science");
